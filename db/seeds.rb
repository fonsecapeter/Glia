...
ANSWERS = [
  ...
  ['<p>The term "frontotemporal dementia" (FTD) includes three different clinical subtypes: <ul><li>behavioral variant FTD (also historically called "frontal variant FTD" or "Pick\'s Disease")</li><li>semantic dementia</li><li>progressive non-fluent aphasia</li></ul></p><img src="http://www.mhhe.com/cls/psy/ch02/brain.gif" /><p>The specific areas of the brain affected by each subtype cause different symptoms for each type.</p>']
]
